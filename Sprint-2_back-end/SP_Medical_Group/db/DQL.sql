...
-- Infomações completas de Pacientes
SELECT 
	IdPaciente, 
	Nome, 
	U.Email,
...
-- Infomações completas da Clínica
SELECT 
	IdClinica,
	Nome,
	CNPJ,
...
-- Infomações completas dos Médicos da Clínica
SELECT 
	IdMedico,
	M.Nome,
	U.Email,
...
SELECT dbo.QuantidadeDeMedicos('Psiquiatria') AS [Quantidade de Médicos];
